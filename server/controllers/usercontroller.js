        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log("auth");
                    return [4 /*yield*/, req.headers.authorization];
                case 1:
                    authHeader = _a.sent();
                    ...
                    console.log(token);
                    if (!token)
                        return [2 /*return*/, res.status(401).json({ msg: "no token supplied" })];
                    return [4 /*yield*/, jwt.verify(token, "" + process.env.jwtSecret, function (err, user) {
                            if (err)
